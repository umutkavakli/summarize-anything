...
def load_transcript(url):
    if not check_link(url):
        return "Invalid Youtube URL. Please check and correct the link."
    try:
...
def get_prompts():
    ...
    1. Capture the essence of the video by focusing on the main ideas and key details. 
    ...
    1. Your beginning sentence will be "Here is the summary of the video:" 
